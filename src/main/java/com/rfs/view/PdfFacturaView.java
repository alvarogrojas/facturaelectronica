...
public class PdfFacturaView extends PdfiTextView {
    ...
    //0049aa
    static final BaseColor BACK_GROUND_TABLE_HEADER_COLOR = new BaseColor(23,169,227); // CELESTE

//    static final BaseColor TABLE_HEADER_FONT_COLOR = new BaseColor(0,73,179);
//    static final BaseColor TABLE_BODY_FONT_COLOR = new BaseColor(0,73,179);  // AZUL OSCURO MORADO
//    static final BaseColor TABLE_BORDER_COLOR = new BaseColor(0,73,179); //AZUL OSCURO
    static final BaseColor TABLE_HEADER_FONT_COLOR = new BaseColor(67,78,89);
    static final BaseColor TABLE_BODY_FONT_COLOR = new BaseColor(67,78,89);  // AZUL OSCURO MORADO
    static final BaseColor TABLE_BORDER_COLOR = new BaseColor(67,78,89); //AZUL OSCURO
//
//    static final BaseColor TABLE_HEADER_FONT_COLOR = new BaseColor(35,59,102);
//    static final BaseColor TABLE_BODY_FONT_COLOR = new BaseColor(35,59,102);  // AZUL OSCURO MORADO
//    static final BaseColor TABLE_BORDER_COLOR = new BaseColor(31,78,121); //AZUL OSCURO
    ...
    public void createPdf(Document document)
        ...
        if (this.notaCreditoDataDTO==null) {
            document.close();
        } else {
            document.newPage();
            this.notaCreditoView.buildPdfDocument(model, document, this.pdfWriter, this.request, this.response);
        }
    }
...
//        if (this.facturaDataDTO.getMonedas()==null) {
//            return;
//        }
...
//        for (TipoCambio tc: this.facturaDataDTO.getMonedas()) {
...
//        }
    ...
    public PdfPTable createLeyDevolucionesTable() throws IOException, DocumentException {
        ...
        PdfPCell cell;
            cell = getCellData("Esta factura constituye título ejecutivo y se rige por el artículo 460 del código de comercio y devengara intereses de 4% mensual a partir del vencimiento. En caso de devolución presente este documento en un plazo máximo de 8 dias! Autorizado mediante la resolucion DGT-R-033-2019 del veinte de junio de dos mil diecinueve de la Direccion General de Tributacion", 6f, Font.BOLD, TABLE_BODY_FONT_COLOR, Element.ALIGN_LEFT, null, 1, null, null, null);


        //cell.setRowspan(3);
        rootTable1.addCell(cell);
        if (this.facturaDataDTO.getEnviadaHacienda()==1 || this.facturaDataDTO.getEnviadaHacienda()==0) {

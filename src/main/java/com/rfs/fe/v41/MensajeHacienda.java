...
package com.rfs.fe.v41;

import com.rfs.fe.SignatureType;
...
@XmlRootElement(name = "MensajeHacienda", namespace = "https://tribunet.hacienda.go.cr/docs/esquemas/2016/v4.1/mensajeHacienda")
public class MensajeHacienda {

    @XmlElement(name = "Clave", namespace = "https://tribunet.hacienda.go.cr/docs/esquemas/2016/v4.1/mensajeHacienda", required = true)
    protected String clave;
    @XmlElement(name = "NombreEmisor", namespace = "https://tribunet.hacienda.go.cr/docs/esquemas/2016/v4.1/mensajeHacienda", required = true)
    protected String nombreEmisor;
    @XmlElement(name = "TipoIdentificacionEmisor", namespace = "https://tribunet.hacienda.go.cr/docs/esquemas/2016/v4.1/mensajeHacienda", required = true)
    protected String tipoIdentificacionEmisor;
    @XmlElement(name = "NumeroCedulaEmisor", namespace = "https://tribunet.hacienda.go.cr/docs/esquemas/2016/v4.1/mensajeHacienda", required = true)
    protected String numeroCedulaEmisor;
    @XmlElement(name = "NombreReceptor", namespace = "https://tribunet.hacienda.go.cr/docs/esquemas/2016/v4.1/mensajeHacienda")
    protected String nombreReceptor;
    @XmlElement(name = "TipoIdentificacionReceptor", namespace = "https://tribunet.hacienda.go.cr/docs/esquemas/2016/v4.1/mensajeHacienda")
    protected String tipoIdentificacionReceptor;
    @XmlElement(name = "NumeroCedulaReceptor", namespace = "https://tribunet.hacienda.go.cr/docs/esquemas/2016/v4.1/mensajeHacienda")
    protected String numeroCedulaReceptor;
    @XmlElement(name = "Mensaje", namespace = "https://tribunet.hacienda.go.cr/docs/esquemas/2016/v4.1/mensajeHacienda", required = true)
    protected BigInteger mensaje;
    @XmlElement(name = "DetalleMensaje", namespace = "https://tribunet.hacienda.go.cr/docs/esquemas/2016/v4.1/mensajeHacienda", required = false)
    protected String detalleMensaje;
    @XmlElement(name = "MontoTotalImpuesto", namespace = "https://tribunet.hacienda.go.cr/docs/esquemas/2016/v4.1/mensajeHacienda")
    protected BigDecimal montoTotalImpuesto;
    @XmlElement(name = "TotalFactura", namespace = "https://tribunet.hacienda.go.cr/docs/esquemas/2016/v4.1/mensajeHacienda", required = false)
